...
class BlankFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewFragment=inflater.inflate(R.layout.fragment_blank_fragment2, container, false)
        setHasOptionsMenu(true)
        bundle= arguments!!.getString("name")!!
        return viewFragment
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mDocContentEditText.layoutManager= LinearLayoutManager(context) as RecyclerView.LayoutManager?
    ...
    public override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        when (requestCode) {
            ...
            REQUEST_CODE_OPEN_DOCUMENT -> if (resultCode == Activity.RESULT_OK && resultData != null) {
                ...
                mDriveServiceHelper?.addFile(file,flag,bundle)
                query(bundle)
            }
            REQUEST_CODE_CREATE_DOCUMENT -> if (resultCode == Activity.RESULT_OK && resultData != null) {
                ...
                mDriveServiceHelper!!.createFile(textFile,nameFile,bundle)
                query(bundle)
            }
        }
...
//    }
    ...
    fun query(parent:String?=null) {
        ...
        mDriveServiceHelper!!.queryFiles(bundle)?.addOnSuccessListener { result ->
    ...
    fun createFolder(){
        ...
        mDialog
            ...
            .setPositiveButton("Создать", DialogInterface.OnClickListener() { _: DialogInterface, _: Int ->
                mDriveServiceHelper!!.createFolder(folderName.toString(),bundle)
                query()
            })
